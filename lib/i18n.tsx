...
export const TRANSLATIONS = {
  ja: {
    ...
    phrases_import_link: 'Source を追加 →',
  ...
  en: {
    ...
    nav_quiz: 'Practice',
    nav_quiz_desc: "Practice the phrases you've Picked",
    nav_history: 'Progress',
    nav_history_desc: 'Track your Pick Streak and accuracy',
    nav_phrases: 'My Picks',
    nav_phrases_desc: 'Search your Picked phrases',
    nav_import: 'Add a Source',
    nav_import_desc: 'Add a source and AI will start Picking',

    // quiz
    quiz_loading: 'Loading...',
    quiz_empty: 'No Picks yet',
    quiz_empty_link: 'Add a Source →',
    ...
    phrases_import_link: 'Add a Source →',
