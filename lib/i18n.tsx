...
export const TRANSLATIONS = {
  ja: {
    ...
    nav_import: 'インポート',
    nav_import_desc: '字幕・テキストからフレーズを登録',

    // quiz
    quiz_loading: '読み込み中...',
    quiz_empty: 'フレーズが登録されていません',
    quiz_empty_link: 'インポートして追加 →',
  ...
  en: {
    ...
    // home
    tagline: 'Master engineer English in real-world context',
    nav_quiz: 'Quiz',
    ...
    nav_import: 'Import',
    nav_import_desc: 'Register phrases from transcripts or text',

    // quiz
    quiz_loading: 'Loading...',
    quiz_empty: 'No phrases registered yet',
    quiz_empty_link: 'Go to Import →',
    ...
    phrases_import_link: 'Go to Import →',
