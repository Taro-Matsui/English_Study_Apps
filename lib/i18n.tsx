...
export const TRANSLATIONS = {
  ja: {
    ...
    nav_import: 'フレーズをPickする',
    nav_import_desc: '会話録・記事・字幕からAIがフレーズをPickします',

    // quiz
    quiz_loading: '読み込み中...',
    quiz_empty: 'フレーズが登録されていません',
    quiz_empty_link: 'フレーズをPickする →',
    ...
    phrases_import_link: 'フレーズをPickする →',
  ...
  en: {
    ...
    nav_import: 'Pick Phrases',
    nav_import_desc: 'AI picks phrases from your real conversations',

    // quiz
    quiz_loading: 'Loading...',
    quiz_empty: 'No phrases registered yet',
    quiz_empty_link: 'Pick phrases →',
    ...
    phrases_import_link: 'Pick phrases →',
